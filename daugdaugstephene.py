...
import streamlit as st # pip install streamlit==1.7.0 # pip install streamlit==1.12.0
from PIL import Image # pip install Pillow==9.2.0
from streamlit_option_menu import option_menu # pip install streamlit-option-menu==0.3.2


# --- PATH SETTINGS ---
current_dir = Path(__file__).parent if "__file__" in locals() else Path.cwd()
aj = current_dir / "assets" / "aj.png"
...
if selected == "Personal Information":
    ...
    with cols4:
        with st.container():
         ...
         st.write("SCHOOL : Surigao Del Norte State University(SNSU)")
